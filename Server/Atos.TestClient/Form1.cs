...
namespace Atos.TestClient
{
    public partial class Form1 : Form
    {
        ...
        {
            string payloadString = Json.CreateSendJson(0, 0, "s", 0, 79, 0, 0, -1, -1);
        ...
        {
            string payloadString = Json.CreateSendJson(0, 0, "s", 0, 79, -1, -1, 0, -1);
        ...
        {
            string payloadString = Json.CreateSendJson(0, 0, "s", 0, 60, 3, 0, 0, 0);
