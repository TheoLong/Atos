...
{   
    ...
    /*Set period */ 
    PLIB_TMR_Period16BitSet(TMR_ID_2, 100);
    /* Setup Interrupt */   
...
{   
    ...
    /*Set period */ 
    PLIB_TMR_Period16BitSet(TMR_ID_4, 1000);
    /* Setup Interrupt */   
...
{   
    ...
    /* Select prescalar value */
    PLIB_TMR_PrescaleSelect(TMR_ID_5, TMR_PRESCALE_VALUE_256);
    /* Enable 16 bit mode */
    PLIB_TMR_Mode16BitEnable(TMR_ID_5);
    /* Clear counter */ 
    PLIB_TMR_Counter16BitClear(TMR_ID_5);
    /*Set period */ 
    PLIB_TMR_Period16BitSet(TMR_ID_5, 31250);
    /* Setup Interrupt */   
